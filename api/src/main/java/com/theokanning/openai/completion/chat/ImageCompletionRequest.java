...
public class ImageCompletionRequest {
    ...
    ImageCompletionRequestFunctionCall functionCall;

    @Data
    @Builder
    @AllArgsConstructor
    @NoArgsConstructor
    public static class ImageCompletionRequestFunctionCall {
        String name;

        public static ImageCompletionRequestFunctionCall of(String name) {
            return new ImageCompletionRequestFunctionCall(name);
        }
